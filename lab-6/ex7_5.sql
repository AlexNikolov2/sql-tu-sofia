select students.name as StudentName, sum(taxesPayments.paymentAmount) as TotalFees, taxesPayments.month as Month, taxesPayments.year as Year from students
