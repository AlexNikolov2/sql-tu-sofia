...
create table football(id int auto_increment primary key, student_id int, coach_id int, foreign key (student_id) references students(id) on delete cascade, foreign key (coach_id) references coaches(id) on delete cascade);

create table volleyball(id int auto_increment primary key, student_id int, coach_id int, foreign key (student_id) references students(id) on delete cascade, foreign key (coach_id) references coaches(id) on delete cascade);
